...
- **Deep Learning:** Neural Networks, Autoencoders, RBF Networks, Transfer Learning, Reinforcement Learning (DQN)
- **NLP & Text Processing:** Sentiment Analysis, Intent Detection, Spam Detection, Text Classification
- **Web Development:** Streamlit, Gradio, FastAPI, Next.js, Data Visualization (Plotly, Folium)
- **Engineering & Analytics:** Industrial Engineering principles, Statistical Analysis, Data Visualization, Geospatial Analysis
...
| [Forbidden Zone Detection](https://github.com/BerkeTozkoparam/forbidden-zone-detection) | Real-time intrusion detection into restricted areas | Python, YOLOv8 |
| [Early Fire Detection](https://github.com/BerkeTozkoparam/Early-Fire-Detection-Hybrid) | Hybrid YOLOv8 + IoT sensor ML system with Streamlit UI | Python, Streamlit |
| [Traffic Analysis YOLO](https://github.com/BerkeTozkoparam/traffic-analysis-yolo) | Real-time traffic analysis and vehicle counting | Python, YOLOv8 |
| [Traffic Sign Detection](https://github.com/BerkeTozkoparam/traffic-sign-detection) | YOLOv8 traffic sign detection for autonomous driving | Python, Streamlit |
| [Welding Spatter Detection](https://github.com/BerkeTozkoparam/welding-spatter-detection) | Welding quality control via spatter detection | Python, YOLOv8 |
| [Face Emotion Recognition](https://github.com/BerkeTozkoparam/Face-Emotion-Recognition) | Deep learning emotion classification from facial expressions | Python, CNN |
| [YOLO Car Tracking](https://github.com/BerkeTozkoparam/yolo-car-tracking) | Multi-object vehicle tracking and trajectory analysis | Python, YOLOv8 |
| [License Plate OCR](https://github.com/BerkeTozkoparam/yolo-plate-ocr) | Real-time license plate detection and character recognition | Python, Streamlit |
| [Aircraft Classification](https://github.com/BerkeTozkoparam/aircraft-classification-demo) | CNN-based aircraft image classification | Python, Keras |
| [CIFAR-10 CNN](https://github.com/BerkeTozkoparam/cifar10-cpu-cnn) | CPU-optimized CIFAR-10 classification with Streamlit UI | Python, Streamlit |
| [Eye Sentinel](https://github.com/BerkeTozkoparam/eye-sentinel) | Eye tracking and monitoring system | Python, Computer Vision |
| [Fire Detection YOLOv8](https://github.com/BerkeTozkoparam/Fire-Detection-with-YOLOv8-) | Fire detection for early warning systems | Python, YOLOv8 |
| [YOLOv8 Custom Training](https://github.com/BerkeTozkoparam/yolov8_custom_training_detection) | Custom YOLO training pipeline | Python, YOLOv8 |
...
| [Violations Analytics](https://github.com/BerkeTozkoparam/violations-analytics) | ML-based threat forecasting dashboard | Python, Streamlit |
| [Turkey COVID-19 Analysis](https://github.com/BerkeTozkoparam/Turkey-Covid19-Analysis) | EDA and time series analysis | Python, Jupyter |
...
| [RBF Neural Network](https://github.com/BerkeTozkoparam/Rbf-Neural-Network-Gradio) | Custom Radial Basis Function network for Iris classification | Python, Gradio |
| [Sensor Fault Detector](https://github.com/BerkeTozkoparam/sensor-fault-detector) | Predictive maintenance ML model with Gradio interface | Python, Gradio |
| [UNet Segmentation](https://github.com/BerkeTozkoparam/unet-segmentation-demo) | U-Net semantic segmentation implementation | Python, TensorFlow |
| [Fashion AI](https://github.com/BerkeTozkoparam/fashion-ai) | CNN-based fashion compatibility analyzer | Python, MobileNetV2 |
...
| [Phishing URL Detector](https://github.com/BerkeTozkoparam/AI-Phishing-URL-Detector) | ML-based phishing URL classification | Python, Scikit-learn |
| [Turkish Prescription Assistant](https://github.com/BerkeTozkoparam/Turkish-Prescription-Assistan) | Offline LLM-based drug analysis and scheduling | Python |
...
| [Earthquake Building Damage](https://github.com/BerkeTozkoparam/earthquake-building-damage) | Damage prediction from earthquake parameters | Python, TensorFlow |
| [COVID-19 Symptom Checker](https://github.com/BerkeTozkoparam/COVID-19-Symptom-Checker) | Symptom-based COVID-19 risk prediction | Python, Streamlit |
...
| [Drone Controller](https://github.com/BerkeTozkoparam/drone-controller) | Gesture-based drone control system | Python, MediaPipe, OpenCV |
| [AI Data Analyst](https://github.com/BerkeTozkoparam/Ai-data-analyst) | Multi-agent data analysis with Autogen | Python, Streamlit |
| [Credit Card Fraud Detection](https://github.com/BerkeTozkoparam/creditcard-fraud-prediction) | RandomForest-based fraud prediction dashboard | Python, Streamlit |
| [August 30 Victory Day Portal](https://github.com/BerkeTozkoparam/30agustos_bilgi_portali) | Interactive historical information portal | Python, Streamlit |
| [CO2 Emission Prediction](https://github.com/BerkeTozkoparam/co2-emission-prediction) | Vehicle emission forecasting model | Python, Streamlit |
| [Stress-Success Analysis](https://github.com/BerkeTozkoparam/Stress-Success-Analysis) | Success prediction from lifestyle data | Python, Streamlit |
...
Ask me about: **YOLOv8**, **FastAPI**, **Predictive Maintenance**, **Computer Vision**, **Deep Learning**
